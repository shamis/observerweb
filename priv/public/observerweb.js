...
var _user$project$Json_AllocatorData$Timestamped = F2(
	function (a, b) {
		return {time: a, data: b};
	});
var _user$project$Json_AllocatorData$Allocator = function (a) {
	return {allocator: a};
};
var _user$project$Json_AllocatorData$AllocatorData = F3(
	function (a, b, c) {
		return {name: a, bs: b, cs: c};
	});
var _user$project$Json_AllocatorData$dataDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_AllocatorData$AllocatorData))));
var _user$project$Json_AllocatorData$timestampedDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'data',
	_elm_lang$core$Json_Decode$list(_user$project$Json_AllocatorData$dataDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'time',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_AllocatorData$Timestamped)));
var _user$project$Json_AllocatorData$allocatorDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'allocator',
	_user$project$Json_AllocatorData$timestampedDecoder,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_AllocatorData$Allocator));
var _user$project$Json_AllocatorData$getAllocator = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_malloc'),
	_user$project$Json_AllocatorData$allocatorDecoder);

var _user$project$Json_IoData$Io = F3(
	function (a, b, c) {
		return {input: a, output: b, time: c};
	});
var _user$project$Json_IoData$ioDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'time',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'input',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_IoData$Io))));
var _user$project$Json_IoData$getIo = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_perf&type=io'),
	_user$project$Json_IoData$ioDecoder);

var _user$project$Json_MemoryData$Memory = F7(
	function (a, b, c, d, e, f, g) {
		return {total: a, processes: b, atom: c, binary: d, code: e, ets: f, time: g};
	});
var _user$project$Json_MemoryData$memoryDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'time',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'total',
							_elm_lang$core$Json_Decode$int,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_MemoryData$Memory))))))));
var _user$project$Json_MemoryData$getMemory = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_perf&type=memory'),
	_user$project$Json_MemoryData$memoryDecoder);

var _user$project$Json_NodesData$Nodes = function (a) {
	return {nodes: a};
};
var _user$project$Json_NodesData$nodesDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'nodes',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_NodesData$Nodes));
var _user$project$Json_NodesData$ConnectNodeResponse = F3(
	function (a, b, c) {
		return {node: a, connected: b, message: c};
	});
var _user$project$Json_NodesData$connectNodeResponseDecoder = A4(
	...
	A3(
		...
		A3(
			...
			'node',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_NodesData$ConnectNodeResponse))));

var _user$project$Json_PortsData$Port = F7(
	function (a, b, c, d, e, f, g) {
		return {output: a, os_pid: b, name: c, links: d, input: e, id: f, connected: g};
	});
var _user$project$Json_PortsData$portDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'connected',
	_elm_lang$core$Json_Decode$string,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'output',
							_elm_lang$core$Json_Decode$int,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_PortsData$Port))))))));
var _user$project$Json_PortsData$Ports = function (a) {
	return {ports: a};
};
var _user$project$Json_PortsData$portsDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'port_table',
	_elm_lang$core$Json_Decode$list(_user$project$Json_PortsData$portDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_PortsData$Ports));
var _user$project$Json_PortsData$getPorts = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_ports'),
	_user$project$Json_PortsData$portsDecoder);

var _user$project$Json_ProcessData$Process = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {current_function: a, memory: b, message_queue_len: c, registered_name: d, initial_call: e, pid: f, reductions: g, status: h, group_leader: i, total_heap_size: j, stack_size: k, links: l, ancestors: m, monitors: n, garbage_collection: o};
														};
													};
												};
											};
...
var _user$project$Json_ProcessData$GarbageCollection = F2(
	function (a, b) {
		return {min_heap_size: a, fullsweep_after: b};
	});
var _user$project$Json_ProcessData$gcDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'fullsweep_after',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		'min_heap_size',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_ProcessData$GarbageCollection)));
var _user$project$Json_ProcessData$processDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'garbage_collection',
	_user$project$Json_ProcessData$gcDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'monitors',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
												...
												A3(
													...
													A3(
														...
														A3(
															...
															'current_function',
															_elm_lang$core$Json_Decode$string,
															_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_ProcessData$Process))))))))))))))));
var _user$project$Json_ProcessData$Processes = function (a) {
	return {processes: a};
};
var _user$project$Json_ProcessData$processesDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'process_table',
	_elm_lang$core$Json_Decode$list(_user$project$Json_ProcessData$processDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_ProcessData$Processes));
var _user$project$Json_ProcessData$getProcesses = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_pro&type=all'),
	_user$project$Json_ProcessData$processesDecoder);

var _user$project$Json_SchedulerData$shedulersUtilization = F3(
	function (schedulerid, _p0, last_schedulers) {
		var _p1 = _p0;
		var last_values = A2(_elm_lang$core$Dict$get, schedulerid, last_schedulers);
		var _p2 = last_values;
		if (_p2.ctor === 'Just') {
			var _p3 = _p2._0;
			return {
				schedulerid: schedulerid,
				utilization: _elm_lang$core$Basics$floor(
					(100 * _elm_lang$core$Basics$toFloat(_p1._0 - _p3.activetime)) / _elm_lang$core$Basics$toFloat(_p1._1 - _p3.totaltime))
			};
		} else {
			return {schedulerid: schedulerid, utilization: 0};
		}
	});
var _user$project$Json_SchedulerData$Data = F3(
	function (a, b, c) {
		return {schedulerid: a, activetime: b, totaltime: c};
	});
var _user$project$Json_SchedulerData$dataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'totaltime',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			'schedulerid',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_SchedulerData$Data))));
var _user$project$Json_SchedulerData$Timestamped = F2(
	function (a, b) {
		return {time: a, data: b};
	});
var _user$project$Json_SchedulerData$timestampedDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'data',
	_elm_lang$core$Json_Decode$list(_user$project$Json_SchedulerData$dataDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'time',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_SchedulerData$Timestamped)));
var _user$project$Json_SchedulerData$Scheduler = function (a) {
	return {scheduler: a};
};
var _user$project$Json_SchedulerData$schedulerDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'scheduler',
	_user$project$Json_SchedulerData$timestampedDecoder,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_SchedulerData$Scheduler));
var _user$project$Json_SchedulerData$getSchedulers = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_perf&type=scheduler'),
	_user$project$Json_SchedulerData$schedulerDecoder);
var _user$project$Json_SchedulerData$ShedulersUtilization = F2(
	function (a, b) {
		return {schedulerid: a, utilization: b};
	});

var _user$project$Json_SystemData$Value = F2(
	function (a, b) {
		return {name: a, value: b};
	});
var _user$project$Json_SystemData$valueDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'value',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'name',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_SystemData$Value)));
var _user$project$Json_SystemData$SystemInfo = F4(
	function (a, b, c, d) {
		return {cpu: a, memory: b, statistics: c, system: d};
	});
var _user$project$Json_SystemData$Timestamped = F2(
	function (a, b) {
		return {time: a, data: b};
	});
var _user$project$Json_SystemData$timestampedDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'data',
	_elm_lang$core$Json_Decode$list(_user$project$Json_SystemData$valueDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'time',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_SystemData$Timestamped)));
var _user$project$Json_SystemData$systemInfoDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'system',
	_user$project$Json_SystemData$timestampedDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'statistics',
		_user$project$Json_SystemData$timestampedDecoder,
		A3(
			...
			A3(
				...
				'cpu',
				_user$project$Json_SystemData$timestampedDecoder,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_SystemData$SystemInfo)))));
var _user$project$Json_SystemData$getSystem = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_sys'),
	_user$project$Json_SystemData$systemInfoDecoder);

var _user$project$Json_TablesData$Table = F7(
	function (a, b, c, d, e, f, g) {
		return {name: a, table_type: b, protection: c, owner: d, table_size: e, memory: f, compressed: g};
	});
var _user$project$Json_TablesData$tableDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'compressed',
	_elm_lang$core$Json_Decode$bool,
	A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'name',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_TablesData$Table))))))));
var _user$project$Json_TablesData$TableData = function (a) {
	return {table_data: a};
};
var _user$project$Json_TablesData$tableDataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'ets_table_data',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_TablesData$TableData));
var _user$project$Json_TablesData$getTableData = function (table) {
	return A3(
		_elm_lang$http$Http$post,
		'/info',
		A2(
			...
			'text/plain',
			A2(_elm_lang$core$Basics_ops['++'], 'action=get_tables&table=', table)),
		_user$project$Json_TablesData$tableDataDecoder);
};
var _user$project$Json_TablesData$Tables = function (a) {
	return {tables: a};
};
var _user$project$Json_TablesData$tablesDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'ets_table',
	_elm_lang$core$Json_Decode$list(_user$project$Json_TablesData$tableDecoder),
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Json_TablesData$Tables));
var _user$project$Json_TablesData$getTables = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_tables'),
	_user$project$Json_TablesData$tablesDecoder);

var _user$project$Views_Page$body = function (contents) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'padding-bottom', '2cm'),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Pages_About$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Pages_About$view = function (model) {
	return _user$project$Views_Page$body(
		A2(
...
var _user$project$Pages_About$model = {};
var _user$project$Pages_About$Model = {};
var _user$project$Pages_About$Noop = {ctor: 'Noop'};

var _user$project$Pages_Applications$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Pages_Applications$view = function (model) {
	return _user$project$Views_Page$body(
		A2(
			_evancz$elm_markdown$Markdown$toHtml,
			{ctor: '[]'},
...
var _user$project$Pages_Applications$update = F2(
	function (action, model) {
		var _p1 = action;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Pages_Applications$model = {};
var _user$project$Pages_Applications$Model = {};
var _user$project$Pages_Applications$Noop = {ctor: 'Noop'};

var _user$project$Pages_LoadCharts$unit = function (max) {
	var kb = (max / 1024) | 0;
	var mb = (kb / 1024) | 0;
	var gb = (mb / 1024) | 0;
	return (_elm_lang$core$Native_Utils.cmp(gb, 10) > 0) ? 'GB' : ((_elm_lang$core$Native_Utils.cmp(mb, 10) > 0) ? 'MB' : ((_elm_lang$core$Native_Utils.cmp(kb, 0) > 0) ? 'KB' : 'B'));
};
var _user$project$Pages_LoadCharts$scaleValue = F2(
	function (max, value) {
		var kb = (max / 1024) | 0;
		var mb = (kb / 1024) | 0;
		var gb = (mb / 1024) | 0;
		return (_elm_lang$core$Native_Utils.cmp(gb, 10) > 0) ? ((value / ((1024 * 1024) * 1024)) | 0) : ((_elm_lang$core$Native_Utils.cmp(mb, 10) > 0) ? ((value / (1024 * 1024)) | 0) : ((_elm_lang$core$Native_Utils.cmp(kb, 0) > 0) ? ((value / 1024) | 0) : value));
	});
var _user$project$Pages_LoadCharts$graph_data = F2(
	function (columns, data_list) {
		var r = A2(
			_elm_lang$core$List$map,
			function (d) {
				var l = A2(
				...
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$String$join, ',', l),
						']'));
			},
			data_list);
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(columns),
				A2(
					_elm_lang$core$Basics_ops['++'],
					',',
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$String$join, ',', r),
						']'))));
	});
var _user$project$Pages_LoadCharts$columns = function (l) {
	return {ctor: '::', _0: 'time', _1: l};
};
var _user$project$Pages_LoadCharts$googleChart = _elm_lang$html$Html$node('google-chart');
var _user$project$Pages_LoadCharts$updateIo = F2(
	function (io, model) {
		var s = function () {
			var _p1 = model.last_io;
			if (_p1.ctor === 'Just') {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					model.io_graph_data,
					{
						...
						_0: {
							...
							io: {
								ctor: '::',
								_0: io.input - _p1._0._0,
								_1: {
									ctor: '::',
									_0: io.output - _p1._0._1,
									_1: {ctor: '[]'}
								}
							}
						},
		...
		var m = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(s),
			20) > 0) ? A2(_elm_lang$core$List$drop, 1, s) : s;
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				io_graph_data: m,
				last_io: _elm_lang$core$Maybe$Just(
					{ctor: '_Tuple2', _0: io.input, _1: io.output})
			});
	});
var _user$project$Pages_LoadCharts$updateMemory = F2(
...
var _user$project$Pages_LoadCharts$updateSchedulers = F2(
	function (schedulers, model) {
		var d = A2(
			_elm_lang$core$List$map,
			function (scheduler) {
				return A3(
					_user$project$Json_SchedulerData$shedulersUtilization,
					scheduler.schedulerid,
					{ctor: '_Tuple2', _0: scheduler.activetime, _1: scheduler.totaltime},
					model.last_schedulers);
			},
			schedulers.scheduler.data);
		var s = A2(
			_elm_lang$core$Basics_ops['++'],
			model.shedulers_graph_data,
			{
				ctor: '::',
				_0: {time: schedulers.scheduler.time, shedulers_utilization: d},
				_1: {ctor: '[]'}
			});
		var m = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(s),
		...
		var l = A2(
			...
			function (scheduler) {
				return {
					ctor: '_Tuple2',
					_0: scheduler.schedulerid,
					_1: {activetime: scheduler.activetime, totaltime: scheduler.totaltime}
				};
			},
			schedulers.scheduler.data);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				shedulers_graph_data: m,
				last_schedulers: _elm_lang$core$Dict$fromList(l)
			});
	});
var _user$project$Pages_LoadCharts$model = {
	shedulers_graph_data: {ctor: '[]'},
	last_schedulers: _elm_lang$core$Dict$empty,
	memory_graph_data: {ctor: '[]'},
	io_graph_data: {ctor: '[]'},
	last_io: _elm_lang$core$Maybe$Nothing
};
var _user$project$Pages_LoadCharts$Model = F5(
	function (a, b, c, d, e) {
		return {shedulers_graph_data: a, last_schedulers: b, memory_graph_data: c, io_graph_data: d, last_io: e};
	});
var _user$project$Pages_LoadCharts$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_LoadCharts$subscriptions = function (_p2) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Pages_LoadCharts$Tick);
};
var _user$project$Pages_LoadCharts$NewIo = function (a) {
	return {ctor: 'NewIo', _0: a};
};
var _user$project$Pages_LoadCharts$NewMemory = function (a) {
	return {ctor: 'NewMemory', _0: a};
};
var _user$project$Pages_LoadCharts$NewSchedulers = function (a) {
	return {ctor: 'NewSchedulers', _0: a};
};
var _user$project$Pages_LoadCharts$fetchdata = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: A2(_elm_lang$http$Http$send, _user$project$Pages_LoadCharts$NewSchedulers, _user$project$Json_SchedulerData$getSchedulers),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$http$Http$send, _user$project$Pages_LoadCharts$NewMemory, _user$project$Json_MemoryData$getMemory),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$http$Http$send, _user$project$Pages_LoadCharts$NewIo, _user$project$Json_IoData$getIo),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Pages_LoadCharts$update = F2(
	function (action, model) {
		var _p3 = action;
		switch (_p3.ctor) {
			case 'NewSchedulers':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Pages_LoadCharts$updateSchedulers, _p3._0._0, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'NewMemory':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Pages_LoadCharts$updateMemory, _p3._0._0, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'NewIo':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Pages_LoadCharts$updateIo, _p3._0._0, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_LoadCharts$fetchdata};
		}
	});
var _user$project$Pages_LoadCharts$StringWrapper = function (a) {
	return {ctor: 'StringWrapper', _0: a};
};
var _user$project$Pages_LoadCharts$IntWrapper = function (a) {
	return {ctor: 'IntWrapper', _0: a};
};
var _user$project$Pages_LoadCharts$schedulers_graph = F2(
	function (atr, model) {
		var data = A2(
			_elm_lang$core$List$map,
			function (graph_data) {
				return {
					...
					data: A2(
						_elm_lang$core$List$map,
						function (item) {
							return _user$project$Pages_LoadCharts$IntWrapper(item.utilization);
						},
						graph_data.shedulers_utilization)
				};
			},
			model.shedulers_graph_data);
		var data_with_time = A2(
			_elm_lang$core$List$map,
			function (item) {
				return {
					ctor: '::',
					_0: _user$project$Pages_LoadCharts$StringWrapper(
						A3(_elm_lang$core$String$slice, 11, 19, item.time)),
					_1: item.data
				};
			},
			data);
		var cols = _user$project$Pages_LoadCharts$columns(
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Basics$toString,
				_elm_lang$core$Dict$keys(model.last_schedulers)));
		var data_string = A2(_user$project$Pages_LoadCharts$graph_data, cols, data_with_time);
		return _elm_lang$core$List$isEmpty(data) ? {ctor: '[]'} : A2(
			_elm_lang$core$Basics_ops['++'],
			atr,
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data', data_string),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Pages_LoadCharts$memory_graph = F3(
	function (memory_max_value, atr, model) {
		var data = A2(
			_elm_lang$core$List$map,
			function (graph_data) {
				return {
					...
					data: A2(
						_elm_lang$core$List$map,
						function (item) {
							return _user$project$Pages_LoadCharts$IntWrapper(
								A2(_user$project$Pages_LoadCharts$scaleValue, memory_max_value, item));
						},
						graph_data.memory)
				};
			},
...
var _user$project$Pages_LoadCharts$io_graph = F3(
	function (io_max_value, atr, model) {
		var data = A2(
			_elm_lang$core$List$map,
			function (graph_data) {
				return {
					...
					data: A2(
						...
						function (item) {
							return _user$project$Pages_LoadCharts$IntWrapper(
								A2(_user$project$Pages_LoadCharts$scaleValue, io_max_value, item));
						},
						graph_data.io)
				};
			},
...
var _user$project$Pages_LoadCharts$view = function (model) {
	var attr = {
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'type', 'line'),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'options', '{\"chartArea\": {\"height\": \"100%\"}, \"vAxis\": {\"textPosition\": \"in\"}, \"hAxis\": {\"maxAlternation\":1, \"textPosition\": \"in\"}}'),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'width:90%; margin:auto'),
				_1: {ctor: '[]'}
			}
		}
	};
	var io_max_value = A3(
		...
		F2(
			function (item, acc) {
				var _p4 = _elm_lang$core$List$maximum(item.io);
				if (_p4.ctor === 'Just') {
					return A2(_elm_lang$core$Basics$max, acc, _p4._0);
				} else {
					return acc;
				}
			}),
		0,
		model.io_graph_data);
	var memory_max_value = A3(
		_elm_lang$core$List$foldl,
		F2(
			function (item, acc) {
				var _p5 = _elm_lang$core$List$maximum(item.memory);
				if (_p5.ctor === 'Just') {
					return A2(_elm_lang$core$Basics$max, acc, _p5._0);
				} else {
					return acc;
				}
			}),
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Scheduler Utilization(%)'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: A2(
												_user$project$Pages_LoadCharts$googleChart,
												A2(_user$project$Pages_LoadCharts$schedulers_graph, attr, model),
												{ctor: '[]'}),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														A2(
															...
															A2(
																_elm_lang$core$Basics_ops['++'],
																_user$project$Pages_LoadCharts$unit(memory_max_value),
																')'))),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
									...
									_1: {
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													_user$project$Pages_LoadCharts$googleChart,
													A3(_user$project$Pages_LoadCharts$memory_graph, memory_max_value, attr, model),
													{ctor: '[]'}),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
													...
													{ctor: '[]'},
													{
														...
														_0: _elm_lang$html$Html$text(
															A2(
																...
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	_user$project$Pages_LoadCharts$unit(io_max_value),
																	')'))),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
										...
										_1: {
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														_user$project$Pages_LoadCharts$googleChart,
														A3(_user$project$Pages_LoadCharts$io_graph, io_max_value, attr, model),
														{ctor: '[]'}),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
...
var _user$project$Pages_MemoryAllocators$capitalize = F2(
	function (shouldCapitalize, str) {
		var _p0 = _elm_lang$core$String$uncons(str);
		if (_p0.ctor === 'Nothing') {
			return str;
		} else {
			var _p1 = _p0._0._0;
			var newFirstLetter = shouldCapitalize ? _elm_lang$core$Char$toUpper(_p1) : _elm_lang$core$Char$toLower(_p1);
			return A2(_elm_lang$core$String$cons, newFirstLetter, _p0._0._1);
		}
	});
var _user$project$Pages_MemoryAllocators$graph_data = F2(
	function (columns, data_list) {
		var r = A2(
			_elm_lang$core$List$map,
			function (d) {
...
var _user$project$Pages_MemoryAllocators$columns = function (l) {
	return {ctor: '::', _0: 'time', _1: l};
};
var _user$project$Pages_MemoryAllocators$googleChart = _elm_lang$html$Html$node('google-chart');
var _user$project$Pages_MemoryAllocators$model = {
	carrier_size_graph_data: {ctor: '[]'},
	carrier_utilization_graph_data: {ctor: '[]'},
	carrier_data: {ctor: '[]'}
};
var _user$project$Pages_MemoryAllocators$CarrierSize = F2(
	function (a, b) {
		return {allocator: a, carrier_size: b};
	});
var _user$project$Pages_MemoryAllocators$CarrierUtilization = F2(
	function (a, b) {
		return {allocator: a, utilization: b};
	});
var _user$project$Pages_MemoryAllocators$updateAllocators = F2(
	function (allocators, model) {
		var cu = A2(
			_elm_lang$core$List$map,
			function (allocator) {
				return A2(
					_user$project$Pages_MemoryAllocators$CarrierUtilization,
					allocator.name,
					_elm_lang$core$Basics$floor(
						100 * (_elm_lang$core$Basics$toFloat(allocator.bs) / _elm_lang$core$Basics$toFloat(allocator.cs))));
			},
		...
		var graph_cu = A2(
			...
			{
				ctor: '::',
				_0: {time: allocators.allocator.time, carrier_utilization: cu},
				_1: {ctor: '[]'}
			});
		var l_graph_cu = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(graph_cu),
			20) > 0) ? A2(_elm_lang$core$List$drop, 1, graph_cu) : graph_cu;
		var cs = A2(
			_elm_lang$core$List$map,
			function (allocator) {
				return A2(_user$project$Pages_MemoryAllocators$CarrierSize, allocator.name, allocator.cs);
			},
			allocators.allocator.data);
		var graph_cs = A2(
			_elm_lang$core$Basics_ops['++'],
			...
			{
				ctor: '::',
				_0: {time: allocators.allocator.time, carrier_size: cs},
				_1: {ctor: '[]'}
			});
		var l_graph_cs = (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(graph_cs),
			20) > 0) ? A2(_elm_lang$core$List$drop, 1, graph_cs) : graph_cs;
		return _elm_lang$core$Native_Utils.update(
			model,
			{carrier_size_graph_data: l_graph_cs, carrier_utilization_graph_data: l_graph_cu, carrier_data: allocators.allocator.data});
	});
var _user$project$Pages_MemoryAllocators$Model = F3(
	function (a, b, c) {
		return {carrier_size_graph_data: a, carrier_utilization_graph_data: b, carrier_data: c};
	});
var _user$project$Pages_MemoryAllocators$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_MemoryAllocators$subscriptions = function (_p3) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _user$project$Pages_MemoryAllocators$Tick);
};
var _user$project$Pages_MemoryAllocators$NewAllocator = function (a) {
	return {ctor: 'NewAllocator', _0: a};
};
var _user$project$Pages_MemoryAllocators$fetchdata = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: A2(_elm_lang$http$Http$send, _user$project$Pages_MemoryAllocators$NewAllocator, _user$project$Json_AllocatorData$getAllocator),
		_1: {ctor: '[]'}
	});
var _user$project$Pages_MemoryAllocators$update = F2(
	function (action, model) {
		var _p4 = action;
		if (_p4.ctor === 'NewAllocator') {
			if (_p4._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Pages_MemoryAllocators$updateAllocators, _p4._0._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_MemoryAllocators$fetchdata};
		}
	});
var _user$project$Pages_MemoryAllocators$StringWrapper = function (a) {
	return {ctor: 'StringWrapper', _0: a};
};
var _user$project$Pages_MemoryAllocators$IntWrapper = function (a) {
	return {ctor: 'IntWrapper', _0: a};
};
var _user$project$Pages_MemoryAllocators$carrier_size_graph = F2(
	function (atr, model) {
		var data = A2(
			_elm_lang$core$List$map,
			function (graph_data) {
				return {
					...
					data: A2(
						_elm_lang$core$List$map,
						function (item) {
							return _user$project$Pages_MemoryAllocators$IntWrapper((item.carrier_size / 1024) | 0);
						},
		...
		var data_with_time = A2(
			...
			function (item) {
				return {
					ctor: '::',
					_0: _user$project$Pages_MemoryAllocators$StringWrapper(
						A3(_elm_lang$core$String$slice, 11, 19, item.time)),
					_1: item.data
				};
			},
			data);
		var first = _elm_lang$core$List$head(model.carrier_size_graph_data);
		var allocator_names = function () {
			var _p5 = first;
			if (_p5.ctor === 'Just') {
				return A2(
					_elm_lang$core$List$map,
					function (item) {
						return A2(
							_user$project$Pages_MemoryAllocators$capitalize,
							true,
							A2(_elm_lang$core$String$endsWith, '_alloc', item.allocator) ? A2(_elm_lang$core$String$dropRight, 6, item.allocator) : item.allocator);
					},
					_p5._0.carrier_size);
			} else {
				return {ctor: '[]'};
		...
		var cols = _user$project$Pages_MemoryAllocators$columns(allocator_names);
		var data_string = A2(_user$project$Pages_MemoryAllocators$graph_data, cols, data_with_time);
		return _elm_lang$core$List$isEmpty(data) ? {ctor: '[]'} : A2(
			_elm_lang$core$Basics_ops['++'],
			atr,
			{
...
var _user$project$Pages_MemoryAllocators$carrier_utilization_graph = F2(
	function (atr, model) {
		var data = A2(
			_elm_lang$core$List$map,
			function (graph_data) {
				return {
					...
					data: A2(
						_elm_lang$core$List$map,
						function (item) {
							return _user$project$Pages_MemoryAllocators$IntWrapper(item.utilization);
						},
		...
		var data_with_time = A2(
			...
			data);
		var first = _elm_lang$core$List$head(model.carrier_utilization_graph_data);
		var allocator_names = function () {
			var _p6 = first;
			if (_p6.ctor === 'Just') {
				return A2(
...
var _user$project$Pages_MemoryAllocators$view = function (model) {
	var attr = {
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'type', 'line'),
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'width:100%; margin:auto'),
				_1: {ctor: '[]'}
			}
		}
	};
				...
				_0: A2(
					_debois$elm_mdl$Material_Grid$cell,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'min-width', '375px'),
								_1: {
									ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Memory Allocations'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
										...
										},
										{
											...
											_0: A2(
												_debois$elm_mdl$Material_Table$table,
												{
													...
													_1: {
														ctor: '::',
														_0: A2(_debois$elm_mdl$Material_Options$css, 'border', '0'),
														_1: {ctor: '[]'}
													}
												},
												{
															...
															_0: A2(
																...
																{ctor: '[]'},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Allocator Type'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Block size(KB)'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {
																			ctor: '::',
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text('Carrier size(KB)'),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}
																				...
																				},
																				{
																					...
																					_0: _elm_lang$html$Html$text(
																						A2(
																							_user$project$Pages_MemoryAllocators$capitalize,
																							true,
																							A2(_elm_lang$core$String$endsWith, '_alloc', item.name) ? A2(_elm_lang$core$String$dropRight, 6, item.name) : item.name)),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																				_0: A2(
																					...
																					{ctor: '[]'},
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text(
																							_elm_lang$core$Basics$toString(item.bs)),
																						_1: {ctor: '[]'}
																					}),
																				_1: {
																					ctor: '::',
																					_0: A2(
																						...
																						{ctor: '[]'},
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html$text(
																								_elm_lang$core$Basics$toString(item.cs)),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}
							...
							_0: A2(
								_debois$elm_mdl$Material_Card$view,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-bottom', '10px'),
											_1: {ctor: '[]'}
										}
									}
								},
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Carrier Size(MB)'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
									_1: {
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: A2(
													_user$project$Pages_MemoryAllocators$googleChart,
													A2(_user$project$Pages_MemoryAllocators$carrier_size_graph, attr, model),
													{ctor: '[]'}),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Carrier Utilization(%)'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
										_1: {
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														_user$project$Pages_MemoryAllocators$googleChart,
														A2(_user$project$Pages_MemoryAllocators$carrier_utilization_graph, attr, model),
														{ctor: '[]'}),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
...
var _user$project$Routing$traceOverviewPath = '#trace_overview';
var _user$project$Routing$tablePath = function (id) {
	return A2(_elm_lang$core$Basics_ops['++'], '#table_viewer/', id);
};
var _user$project$Routing$tableViewerPath = '#table_viewer';
var _user$project$Routing$systemPath = '#system';
var _user$project$Routing$portsPath = '#ports';
var _user$project$Routing$processesPath = '#processes';
var _user$project$Routing$processPath = function (id) {
	return A2(_elm_lang$core$Basics_ops['++'], '#processes/', id);
};
var _user$project$Routing$memoryAllocatorsPath = '#memory_alloc';
var _user$project$Routing$loadChartsPath = '#load_charts';
var _user$project$Routing$applicationsPath = '#applications';
var _user$project$Routing$aboutPath = '#about';
var _user$project$Routing$title = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'AboutRoute':
			return 'About';
		case 'ApplicationsRoute':
			return 'Applications';
		case 'LoadChartsRoute':
			return 'LoadCharts';
		case 'MemoryAllocatorsRoute':
			return 'MemoryAllocators';
		case 'SystemRoute':
			return 'System';
		case 'TableViewerRoute':
			return 'TableViewer';
		case 'TableRoute':
			return 'Table Data';
		case 'TraceOverviewRoute':
...
var _user$project$Routing$PortsRoute = {ctor: 'PortsRoute'};
var _user$project$Routing$ProcessRoute = function (a) {
	return {ctor: 'ProcessRoute', _0: a};
};
var _user$project$Routing$ProcessesRoute = {ctor: 'ProcessesRoute'};
var _user$project$Routing$TraceOverviewRoute = {ctor: 'TraceOverviewRoute'};
var _user$project$Routing$TableRoute = function (a) {
	return {ctor: 'TableRoute', _0: a};
};
var _user$project$Routing$TableViewerRoute = {ctor: 'TableViewerRoute'};
var _user$project$Routing$SystemRoute = {ctor: 'SystemRoute'};
var _user$project$Routing$MemoryAllocatorsRoute = {ctor: 'MemoryAllocatorsRoute'};
var _user$project$Routing$LoadChartsRoute = {ctor: 'LoadChartsRoute'};
var _user$project$Routing$ApplicationsRoute = {ctor: 'ApplicationsRoute'};
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Routing$SystemRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Routing$ApplicationsRoute,
					_evancz$url_parser$UrlParser$s('applications')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Routing$LoadChartsRoute,
						_evancz$url_parser$UrlParser$s('load_charts')),
					_1: {
						ctor: '::',
						_0: A2(
							_evancz$url_parser$UrlParser$map,
							_user$project$Routing$MemoryAllocatorsRoute,
							_evancz$url_parser$UrlParser$s('memory_alloc')),
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$url_parser$UrlParser$map,
								_user$project$Routing$ProcessRoute,
								A2(
									_evancz$url_parser$UrlParser_ops['</>'],
									_evancz$url_parser$UrlParser$s('processes'),
									_evancz$url_parser$UrlParser$string)),
							_1: {
								ctor: '::',
								_0: A2(
									_evancz$url_parser$UrlParser$map,
									_user$project$Routing$ProcessesRoute,
									_evancz$url_parser$UrlParser$s('processes')),
								_1: {
									ctor: '::',
									_0: A2(
										_evancz$url_parser$UrlParser$map,
										_user$project$Routing$PortsRoute,
										_evancz$url_parser$UrlParser$s('ports')),
									_1: {
										ctor: '::',
										_0: A2(
											_evancz$url_parser$UrlParser$map,
											_user$project$Routing$SystemRoute,
											_evancz$url_parser$UrlParser$s('system')),
										_1: {
											ctor: '::',
											_0: A2(
												_evancz$url_parser$UrlParser$map,
												_user$project$Routing$TableViewerRoute,
												_evancz$url_parser$UrlParser$s('table_viewer')),
											_1: {
												ctor: '::',
												_0: A2(
													_evancz$url_parser$UrlParser$map,
													_user$project$Routing$TableRoute,
													A2(
														_evancz$url_parser$UrlParser_ops['</>'],
														_evancz$url_parser$UrlParser$s('table_viewer'),
														_evancz$url_parser$UrlParser$string)),
												_1: {
													...
													_0: A2(
														_evancz$url_parser$UrlParser$map,
														_user$project$Routing$TraceOverviewRoute,
														_evancz$url_parser$UrlParser$s('trace_overview')),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Pages_Ports$view = function (model) {
	var ports = function () {
		var _p0 = model.ports;
		if (_p0.ctor === 'Nothing') {
			return {
											...
											_0: A2(
												_elm_lang$html$Html$a,
												{
													...
													_0: _elm_lang$html$Html_Attributes$href(
														_user$project$Routing$processPath(item.connected)),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(item.connected),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
									_1: {
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(item.input)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(item.output)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
														...
														function (l) {
															return A2(
																_elm_lang$html$Html$a,
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$href(
																		_user$project$Routing$processPath(l)),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_debois$elm_mdl$Material_Table$th,
										{
											...
											_1: {
												ctor: '::',
												_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '27%'),
												_1: {ctor: '[]'}
											}
										},
										{
												...
												_1: {
													...
													_0: A2(
														_debois$elm_mdl$Material_Table$th,
														{
															...
															_1: {
																ctor: '::',
																_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '33%'),
																_1: {ctor: '[]'}
															}
														},
														{
...
var _user$project$Pages_Ports$model = {ports: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
var _user$project$Pages_Ports$Model = F2(
	function (a, b) {
		return {ports: a, mdl: b};
	});
var _user$project$Pages_Ports$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_Ports$subscriptions = function (_p1) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$Pages_Ports$Tick);
};
var _user$project$Pages_Ports$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Pages_Ports$NewPorts = function (a) {
	return {ctor: 'NewPorts', _0: a};
};
var _user$project$Pages_Ports$fetchdata = A2(_elm_lang$http$Http$send, _user$project$Pages_Ports$NewPorts, _user$project$Json_PortsData$getPorts);
var _user$project$Pages_Ports$update = F2(
	function (action, model) {
		var _p2 = action;
		switch (_p2.ctor) {
			case 'NewPorts':
				if (_p2._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								ports: _elm_lang$core$Maybe$Just(_p2._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Pages_Ports$Mdl, _p2._0, model);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_Ports$fetchdata};
		}
	});

var _user$project$Pages_Process$monitors_info = function (process) {
	var ancestors = A2(
		_elm_lang$core$List$map,
		function (item) {
			return A2(
	...
	return A2(
		...
		},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Monitors'),
					_1: {
						ctor: '::',
						_0: A2(
...
var _user$project$Pages_Process$ancestors_info = function (process) {
	var ancestors = A2(
		_elm_lang$core$List$map,
		function (item) {
			return A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$a,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href(
										_user$project$Routing$processPath(item)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Ancestors'),
					_1: {
						ctor: '::',
						_0: A2(
							_debois$elm_mdl$Material_List$ul,
...
var _user$project$Pages_Process$links_info = function (process) {
	var links = A2(
		_elm_lang$core$List$map,
		function (item) {
			return A2(
...
var _user$project$Pages_Process$find_prosess_from_pid = F2(
	function (processes, pid) {
		var is_pid = function (s) {
			return A2(_elm_lang$core$String$startsWith, '<', s) && A2(_elm_lang$core$String$endsWith, '>', s);
		};
		var find_prosess = function () {
			var _p0 = {
				ctor: '_Tuple2',
				_0: processes,
				_1: is_pid(pid)
			...
			if (_p0._0.ctor === 'Just') {
				if (_p0._1 === true) {
					return A2(
						_elm_lang$core$List$filter,
						function (p) {
							return _elm_lang$core$Native_Utils.eq(p.pid, pid);
						},
						_p0._0._0.processes);
				} else {
					return A2(
						_elm_lang$core$List$filter,
						function (p) {
							return _elm_lang$core$Native_Utils.eq(p.registered_name, pid);
						},
						_p0._0._0.processes);
				}
			} else {
		...
		return _elm_lang$core$List$head(find_prosess);
	});
var _user$project$Pages_Process$memory_info = function (process) {
	return A2(
		_debois$elm_mdl$Material_Grid$cell,
		{
			ctor: '::',
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Total heap size'),
													_1: {
														ctor: '::',
														_0: A2(
															_debois$elm_mdl$Material_List$subtitle,
															{ctor: '[]'},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(
																	_elm_lang$core$Basics$toString(process.total_heap_size)),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Stack size'),
														_1: {
															ctor: '::',
															_0: A2(
																_debois$elm_mdl$Material_List$subtitle,
																{ctor: '[]'},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		_elm_lang$core$Basics$toString(process.stack_size)),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('GC min heap size'),
															_1: {
																ctor: '::',
																_0: A2(
																	_debois$elm_mdl$Material_List$subtitle,
																	{ctor: '[]'},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(
																			_elm_lang$core$Basics$toString(process.garbage_collection.min_heap_size)),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('GC fullsweep after'),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_debois$elm_mdl$Material_List$subtitle,
																		{ctor: '[]'},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(
																				_elm_lang$core$Basics$toString(process.garbage_collection.fullsweep_after)),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
...
var _user$project$Pages_Process$overview_info = function (process) {
	return A2(
		_debois$elm_mdl$Material_Grid$cell,
		{
			ctor: '::',
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Process id'),
												_1: {
													ctor: '::',
													_0: A2(
														_debois$elm_mdl$Material_List$subtitle,
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(process.pid),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Registered name'),
													_1: {
														ctor: '::',
														_0: A2(
															_debois$elm_mdl$Material_List$subtitle,
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(process.registered_name),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
													...
													{ctor: '[]'},
													{
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(process.status),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Message queue length'),
															_1: {
																ctor: '::',
																_0: A2(
																	_debois$elm_mdl$Material_List$subtitle,
																	{ctor: '[]'},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(
																			_elm_lang$core$Basics$toString(process.message_queue_len)),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Group leader'),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_debois$elm_mdl$Material_List$subtitle,
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(process.group_leader),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
...
var _user$project$Pages_Process$updateProcesses = F2(
	function (processes, model) {
		var process = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (i) {
					return _elm_lang$core$Native_Utils.eq(i.registered_name, model.id) || _elm_lang$core$Native_Utils.eq(i.pid, model.id);
				},
				processes.processes));
		return _elm_lang$core$Native_Utils.update(
			model,
...
var _user$project$Pages_Process$init = function (id) {
	return {id: id, process: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
};
var _user$project$Pages_Process$Model = F3(
	function (a, b, c) {
		return {id: a, process: b, mdl: c};
	});
var _user$project$Pages_Process$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_Process$subscriptions = function (_p1) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$Pages_Process$Tick);
};
var _user$project$Pages_Process$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Pages_Process$BackMsg = {ctor: 'BackMsg'};
var _user$project$Pages_Process$view = function (model) {
	var name = function (item) {
		var _p2 = item.registered_name;
		if (_p2 === '') {
			return item.initial_call;
		} else {
			return _p2;
		}
	};
	var _p3 = model.process;
	if (_p3.ctor === 'Nothing') {
		return _user$project$Views_Page$body(
			A3(
				_debois$elm_mdl$Material_Options$styled,
					...
					_0: A3(
						...
						},
						{
							...
							_0: A5(
								...
								_user$project$Pages_Process$Mdl,
								{
									ctor: '::',
									_0: 0,
									_1: {
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Pages_Process$BackMsg),
											_1: {ctor: '[]'}
										}
									}
								},
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Icon$i('reply'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
						...
						_0: A3(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Pages_Process$overview_info(_p4),
										_1: {
											ctor: '::',
											_0: _user$project$Pages_Process$memory_info(_p4),
											_1: {
												ctor: '::',
												_0: _user$project$Pages_Process$links_info(_p4),
												_1: {
													ctor: '::',
													_0: _user$project$Pages_Process$ancestors_info(_p4),
													_1: {
														ctor: '::',
														_0: _user$project$Pages_Process$monitors_info(_p4),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _user$project$Pages_Process$NewProcesses = function (a) {
	return {ctor: 'NewProcesses', _0: a};
};
var _user$project$Pages_Process$fetchdata = A2(_elm_lang$http$Http$send, _user$project$Pages_Process$NewProcesses, _user$project$Json_ProcessData$getProcesses);
var _user$project$Pages_Process$update = F2(
	function (action, model) {
		var _p5 = action;
		switch (_p5.ctor) {
			case 'NewProcesses':
				if (_p5._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Pages_Process$updateProcesses, _p5._0._0, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Pages_Process$Mdl, _p5._0, model);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_Process$fetchdata};
		}
	});

var _user$project$Pages_Processes$view = function (model) {
	var name = function (item) {
		var _p0 = item.registered_name;
		if (_p0 === '') {
			return item.initial_call;
		} else {
			return _p0;
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href(
												_user$project$Routing$processPath(item.pid)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(item.pid),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(
												_elm_lang$core$Basics$toString(item.reductions)),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{ctor: '[]'},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													_elm_lang$core$Basics$toString(item.memory)),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(item.message_queue_len)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(item.current_function),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_debois$elm_mdl$Material_Table$th,
									{
										...
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '13%'),
											_1: {ctor: '[]'}
										}
									},
									{
								...
								_1: {
									...
									_0: A2(
										_debois$elm_mdl$Material_Table$th,
										{
											...
											_1: {
												ctor: '::',
												_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '24%'),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Name or Initial Func'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Reds'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('MsgQ'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Current Function'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
...
var _user$project$Pages_Processes$updateProcesses = F2(
	function (processes, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				processes: _elm_lang$core$Maybe$Just(processes)
			});
	});
var _user$project$Pages_Processes$model = {processes: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
var _user$project$Pages_Processes$Model = F2(
	function (a, b) {
		return {processes: a, mdl: b};
	});
var _user$project$Pages_Processes$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_Processes$subscriptions = function (_p2) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$Pages_Processes$Tick);
};
var _user$project$Pages_Processes$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Pages_Processes$NewProcesses = function (a) {
	return {ctor: 'NewProcesses', _0: a};
};
var _user$project$Pages_Processes$fetchdata = A2(_elm_lang$http$Http$send, _user$project$Pages_Processes$NewProcesses, _user$project$Json_ProcessData$getProcesses);
var _user$project$Pages_Processes$update = F2(
	function (action, model) {
		var _p3 = action;
		switch (_p3.ctor) {
			case 'NewProcesses':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_user$project$Pages_Processes$updateProcesses, _p3._0._0, model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Pages_Processes$Mdl, _p3._0, model);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_Processes$fetchdata};
		}
	});

var _user$project$Pages_System$card = F3(
	function (_p0, title, data) {
		return A2(
			_debois$elm_mdl$Material_Card$view,
			{
				ctor: '::',
													...
													{ctor: '[]'},
													{
														...
														_1: {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(item.value),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
...
var _user$project$Pages_System$view = function (model) {
	var statistics = function () {
		var _p1 = model.systemInfo;
		if (_p1.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return _p1._0.statistics.data;
		}
	}();
	var cpu = function () {
		var _p2 = model.systemInfo;
		if (_p2.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return _p2._0.cpu.data;
		}
	}();
	var memory = function () {
		var _p3 = model.systemInfo;
		if (_p3.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return _p3._0.memory.data;
		}
	}();
	var system = function () {
		var _p4 = model.systemInfo;
		if (_p4.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return _p4._0.system.data;
		}
	}();
	return _user$project$Views_Page$body(
		A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A3(_user$project$Pages_System$card, model, 'System and Architecture', system),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A3(_user$project$Pages_System$card, model, 'Memory Usage', memory),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: A3(_user$project$Pages_System$card, model, 'CPU\'s and Threads', cpu),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: A3(_user$project$Pages_System$card, model, 'Statistics', statistics),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _user$project$Pages_System$model = {systemInfo: _elm_lang$core$Maybe$Nothing};
var _user$project$Pages_System$Model = function (a) {
	return {systemInfo: a};
};
var _user$project$Pages_System$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_System$subscriptions = function (_p5) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$Pages_System$Tick);
};
var _user$project$Pages_System$NewSystem = function (a) {
	return {ctor: 'NewSystem', _0: a};
};
var _user$project$Pages_System$fetchdata = A2(_elm_lang$http$Http$send, _user$project$Pages_System$NewSystem, _user$project$Json_SystemData$getSystem);
var _user$project$Pages_System$update = F2(
	function (action, model) {
		var _p6 = action;
		if (_p6.ctor === 'NewSystem') {
			if (_p6._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							systemInfo: _elm_lang$core$Maybe$Just(_p6._0._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
			...
			return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_System$fetchdata};
		}
	});

var _user$project$Pages_TableData$init = function (id) {
	return {id: id, tableData: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
};
var _user$project$Pages_TableData$Model = F3(
	function (a, b, c) {
		return {id: a, tableData: b, mdl: c};
	});
var _user$project$Pages_TableData$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_TableData$subscriptions = function (_p0) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$Pages_TableData$Tick);
};
var _user$project$Pages_TableData$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Pages_TableData$BackMsg = {ctor: 'BackMsg'};
var _user$project$Pages_TableData$view = function (model) {
	var table_rows = function (table_data) {
		return A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, r) {
				...
				},
				{
					...
					_0: A3(
						...
						},
						{
							...
							_0: A5(
								_debois$elm_mdl$Material_Button$render,
								_user$project$Pages_TableData$Mdl,
								{
									ctor: '::',
									_0: 0,
									_1: {
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Pages_TableData$BackMsg),
											_1: {ctor: '[]'}
										}
									}
								},
...
var _user$project$Pages_TableData$NewTableData = function (a) {
	return {ctor: 'NewTableData', _0: a};
};
var _user$project$Pages_TableData$fetchdata = function (id) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Pages_TableData$NewTableData,
		_user$project$Json_TablesData$getTableData(id));
};
var _user$project$Pages_TableData$update = F2(
	function (action, model) {
		var _p2 = action;
		switch (_p2.ctor) {
			case 'NewTableData':
				if (_p2._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tableData: _elm_lang$core$Maybe$Just(_p2._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Pages_TableData$Mdl, _p2._0, model);
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Pages_TableData$fetchdata(model.id)
				};
		}
	});

var _user$project$Pages_TableViewer$view = function (model) {
	var tables = function () {
		var _p0 = model.tables;
		if (_p0.ctor === 'Nothing') {
			return {
				ctor: '::',
				_0: A2(
					...
					return A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: ((!_elm_lang$core$Native_Utils.eq(item.protection, 'private')) && (_elm_lang$core$Native_Utils.cmp(item.table_size, 0) > 0)) ? A2(
										_elm_lang$html$Html$a,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href(
												_user$project$Routing$tablePath(item.name)),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(item.table_type),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(item.protection),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$a,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href(
															_user$project$Routing$processPath(item.owner)),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(item.owner),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
										_1: {
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(item.table_size)),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_debois$elm_mdl$Material_Table$th,
									{
										...
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '28%'),
											_1: {ctor: '[]'}
										}
									},
									{
								...
								_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Protection'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Compressed'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
...
var _user$project$Pages_TableViewer$model = {tables: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model};
var _user$project$Pages_TableViewer$Model = F2(
	function (a, b) {
		return {tables: a, mdl: b};
	});
var _user$project$Pages_TableViewer$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Pages_TableViewer$subscriptions = function (_p1) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$Pages_TableViewer$Tick);
};
var _user$project$Pages_TableViewer$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Pages_TableViewer$NewTables = function (a) {
	return {ctor: 'NewTables', _0: a};
};
var _user$project$Pages_TableViewer$fetchdata = A2(_elm_lang$http$Http$send, _user$project$Pages_TableViewer$NewTables, _user$project$Json_TablesData$getTables);
var _user$project$Pages_TableViewer$update = F2(
	function (action, model) {
		var _p2 = action;
		switch (_p2.ctor) {
			case 'NewTables':
				if (_p2._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								tables: _elm_lang$core$Maybe$Just(_p2._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Pages_TableViewer$Mdl, _p2._0, model);
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Pages_TableViewer$fetchdata};
		}
	});

var _user$project$Pages_TraceOverview$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Pages_TraceOverview$view = function (model) {
	return _user$project$Views_Page$body(
		A2(
			_evancz$elm_markdown$Markdown$toHtml,
			{ctor: '[]'},
...
var _user$project$Pages_TraceOverview$update = F2(
	function (action, model) {
		var _p1 = action;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$Pages_TraceOverview$model = {};
var _user$project$Pages_TraceOverview$Model = {};
var _user$project$Pages_TraceOverview$Noop = {ctor: 'Noop'};

var _user$project$Models$initialModel = function (tab) {
	return {
...
var _user$project$Models$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {mdl: a, snackbar: b, tab: c, nodes: d, selectedNode: e, title: f, connectNode: g};
	});
var _user$project$Models$TraceOverview = function (a) {
	return {ctor: 'TraceOverview', _0: a};
};
var _user$project$Models$TableData = function (a) {
	return {ctor: 'TableData', _0: a};
};
var _user$project$Models$TableViewer = function (a) {
	return {ctor: 'TableViewer', _0: a};
};
var _user$project$Models$System = function (a) {
	return {ctor: 'System', _0: a};
};
var _user$project$Models$Ports = function (a) {
	return {ctor: 'Ports', _0: a};
};
var _user$project$Models$Process = function (a) {
	return {ctor: 'Process', _0: a};
};
var _user$project$Models$Processes = function (a) {
	return {ctor: 'Processes', _0: a};
};
var _user$project$Models$MemoryAllocators = function (a) {
	return {ctor: 'MemoryAllocators', _0: a};
};
var _user$project$Models$LoadCharts = function (a) {
	return {ctor: 'LoadCharts', _0: a};
};
var _user$project$Models$Applications = function (a) {
	return {ctor: 'Applications', _0: a};
};
var _user$project$Models$About = function (a) {
	return {ctor: 'About', _0: a};
};
var _user$project$Models$NotFound = {ctor: 'NotFound'};

var _user$project$Msgs$Snackbar = function (a) {
	return {ctor: 'Snackbar', _0: a};
};
var _user$project$Msgs$ConnectNodeResponseMsg = function (a) {
	return {ctor: 'ConnectNodeResponseMsg', _0: a};
};
var _user$project$Msgs$ConnectNodeMsg = {ctor: 'ConnectNodeMsg'};
var _user$project$Msgs$ChangeNodeCookieMsg = function (a) {
	return {ctor: 'ChangeNodeCookieMsg', _0: a};
};
var _user$project$Msgs$ChangeNodeNameMsg = function (a) {
	return {ctor: 'ChangeNodeNameMsg', _0: a};
};
var _user$project$Msgs$NewNodesMsg = function (a) {
	return {ctor: 'NewNodesMsg', _0: a};
};
var _user$project$Msgs$ChangeNode = function (a) {
	return {ctor: 'ChangeNode', _0: a};
};
var _user$project$Msgs$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _user$project$Msgs$AboutMsg = function (a) {
	return {ctor: 'AboutMsg', _0: a};
};
var _user$project$Msgs$TraceOverviewMsg = function (a) {
	return {ctor: 'TraceOverviewMsg', _0: a};
};
var _user$project$Msgs$TableDataMsg = function (a) {
	return {ctor: 'TableDataMsg', _0: a};
};
var _user$project$Msgs$TableViewerMsg = function (a) {
	return {ctor: 'TableViewerMsg', _0: a};
};
var _user$project$Msgs$PortsMsg = function (a) {
	return {ctor: 'PortsMsg', _0: a};
};
var _user$project$Msgs$ProcessesMsg = function (a) {
	return {ctor: 'ProcessesMsg', _0: a};
};
var _user$project$Msgs$ProcessMsg = function (a) {
	return {ctor: 'ProcessMsg', _0: a};
};
var _user$project$Msgs$ApplicationsMsg = function (a) {
	return {ctor: 'ApplicationsMsg', _0: a};
};
var _user$project$Msgs$MemoryAllocatorsMsg = function (a) {
	return {ctor: 'MemoryAllocatorsMsg', _0: a};
};
var _user$project$Msgs$LoadChartsMsg = function (a) {
	return {ctor: 'LoadChartsMsg', _0: a};
};
var _user$project$Msgs$SystemMsg = function (a) {
	return {ctor: 'SystemMsg', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Connect node'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: A5(
							...
							model.mdl,
							{
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Textfield$label('Node name (nonode@nohost)'),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Textfield$value(model.connectNode.nodeName),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Msgs$ChangeNodeNameMsg),
											_1: {ctor: '[]'}
										}
									}
								}
						...
						_1: {
							...
							_0: A5(
								...
								model.mdl,
								{
									...
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Textfield$label('Secret cookie'),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Textfield$value(model.connectNode.nodeCookie),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Msgs$ChangeNodeCookieMsg),
												_1: {ctor: '[]'}
											}
										}
									}
									...
									model.mdl,
									{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Msgs$ConnectNodeMsg),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$View$drawers = function () {
	...
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$systemPath),
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Options$onClick(
						_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text('System'),
					_1: {ctor: '[]'}
				}
			}),
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$loadChartsPath),
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$onClick(
							_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
				...
				},
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text('Load Charts'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$memoryAllocatorsPath),
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onClick(
								_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html$text('Memory Allocators'),
							_1: {ctor: '[]'}
						}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$applicationsPath),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(
									_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
						...
						{
							ctor: '::',
							_0: icon('devices_other'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text('Applications'),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$processesPath),
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(
										_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
							...
							{
								ctor: '::',
								_0: icon('settings_applications'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('Processes'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$portsPath),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onClick(
											_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('Ports'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$tableViewerPath),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$onClick(
												_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
									...
									{
										ctor: '::',
										_0: icon('view_headline'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text('Table Viewer'),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$traceOverviewPath),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onClick(
													_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
										...
										},
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text('Trace Overview'),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _debois$elm_mdl$Material_Layout$href(_user$project$Routing$aboutPath),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onClick(
														_debois$elm_mdl$Material_Layout$toggleDrawer(_user$project$Msgs$Mdl)),
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('ObserverWeb'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: A3(
							...
							_elm_lang$html$Html$img,
							{
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$attribute(
									_elm_lang$html$Html_Attributes$src('img/erlang-official.svg')),
								_1: {
									ctor: '::',
									...
									{ctor: '[]'},
									{
										...
										_0: function () {
											...
											if (_p0.ctor === 'Just') {
												...
												return _elm_lang$html$Html$text('Nodes');
											}
										}(),
										_1: {ctor: '[]'}
									}),
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _debois$elm_mdl$Material_Layout$href('https://github.com/freke/observerweb'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A3(
												...
												_elm_lang$html$Html$img,
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$attribute(
														_elm_lang$html$Html_Attributes$src('img/github.svg')),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$attribute(
															_elm_lang$html$Html_Attributes$alt('github')),
														_1: {
															ctor: '::',
															_0: A2(_debois$elm_mdl$Material_Options$css, 'width', '24px'),
															_1: {
																ctor: '::',
...
var _user$project$View$page = function (model) {
	...
	switch (_p1.ctor) {
		case 'About':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$AboutMsg,
				_user$project$Pages_About$view(_p1._0));
		case 'Applications':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$ApplicationsMsg,
				_user$project$Pages_Applications$view(_p1._0));
		case 'LoadCharts':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$LoadChartsMsg,
				_user$project$Pages_LoadCharts$view(_p1._0));
		case 'MemoryAllocators':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$MemoryAllocatorsMsg,
				_user$project$Pages_MemoryAllocators$view(_p1._0));
		case 'System':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$SystemMsg,
				_user$project$Pages_System$view(_p1._0));
		case 'TableViewer':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$TableViewerMsg,
				_user$project$Pages_TableViewer$view(_p1._0));
		case 'TableData':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$TableDataMsg,
				_user$project$Pages_TableData$view(_p1._0));
		case 'TraceOverview':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$TraceOverviewMsg,
				_user$project$Pages_TraceOverview$view(_p1._0));
		case 'Processes':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$ProcessesMsg,
				_user$project$Pages_Processes$view(_p1._0));
		case 'Process':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$ProcessMsg,
				_user$project$Pages_Process$view(_p1._0));
		case 'Ports':
			return A2(
				_elm_lang$html$Html$map,
				_user$project$Msgs$PortsMsg,
				_user$project$Pages_Ports$view(_p1._0));
		default:
		...
		A4(
			...
			},
			{
				drawer: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$View$drawer(model),
						_1: {ctor: '[]'}
					}
				},
				...
				main: {
					ctor: '::',
					_0: _user$project$View$dialog(model),
					_1: {
						ctor: '::',
		...
		switch (_p0.ctor) {
			...
			case 'About':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$AboutMsg,
					_user$project$Pages_About$subscriptions(_p0._0));
			case 'Applications':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$ApplicationsMsg,
					_user$project$Pages_Applications$subscriptions(_p0._0));
			case 'LoadCharts':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$LoadChartsMsg,
					_user$project$Pages_LoadCharts$subscriptions(_p0._0));
			case 'MemoryAllocators':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$MemoryAllocatorsMsg,
					_user$project$Pages_MemoryAllocators$subscriptions(_p0._0));
			case 'Process':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$ProcessMsg,
					_user$project$Pages_Process$subscriptions(_p0._0));
			case 'Processes':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$ProcessesMsg,
					_user$project$Pages_Processes$subscriptions(_p0._0));
			case 'Ports':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$PortsMsg,
					_user$project$Pages_Ports$subscriptions(_p0._0));
			case 'System':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$SystemMsg,
					_user$project$Pages_System$subscriptions(_p0._0));
			case 'TableViewer':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$TableViewerMsg,
					_user$project$Pages_TableViewer$subscriptions(_p0._0));
			case 'TableData':
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$TableDataMsg,
					_user$project$Pages_TableData$subscriptions(_p0._0));
			default:
				return A2(
					_elm_lang$core$Platform_Sub$map,
					_user$project$Msgs$TraceOverviewMsg,
					_user$project$Pages_TraceOverview$subscriptions(_p0._0));
		}
	}();
	return _elm_lang$core$Platform_Sub$batch(
		{
...
var _user$project$Main$transitionLength = 150 * _elm_lang$core$Time$millisecond;
var _user$project$Main$connectNode = function (model) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$ConnectNodeResponseMsg,
		A3(
			_elm_lang$http$Http$post,
			'/info',
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'action=connect_node&node=',
					A2(
						_elm_lang$core$Basics_ops['++'],
						model.connectNode.nodeName,
						A2(_elm_lang$core$Basics_ops['++'], '&cookie=', model.connectNode.nodeCookie)))),
			_user$project$Json_NodesData$connectNodeResponseDecoder));
};
var _user$project$Main$getNodes = A3(
	_elm_lang$http$Http$post,
	'/info',
	A2(_elm_lang$http$Http$stringBody, 'text/plain', 'action=get_nodes'),
	_user$project$Json_NodesData$nodesDecoder);
var _user$project$Main$changeNode = function (node) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$ConnectNodeResponseMsg,
		A3(
			...
			A2(
				_elm_lang$http$Http$stringBody,
				'text/plain',
				A2(_elm_lang$core$Basics_ops['++'], 'action=change_node&node=', node)),
			_user$project$Json_NodesData$connectNodeResponseDecoder));
};
var _user$project$Main$updateNodes = F2(
	function (nodes, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{nodes: nodes.nodes});
	});
var _user$project$Main$routeToPage = function (route) {
	var _p1 = route;
	switch (_p1.ctor) {
		case 'AboutRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$About(_user$project$Pages_About$model),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		case 'ApplicationsRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$Applications(_user$project$Pages_Applications$model),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		case 'LoadChartsRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$LoadCharts(_user$project$Pages_LoadCharts$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$LoadChartsMsg, _user$project$Pages_LoadCharts$fetchdata)
			};
		case 'MemoryAllocatorsRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$MemoryAllocators(_user$project$Pages_MemoryAllocators$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$MemoryAllocatorsMsg, _user$project$Pages_MemoryAllocators$fetchdata)
			};
		case 'SystemRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$System(_user$project$Pages_System$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$SystemMsg, _user$project$Pages_System$fetchdata)
			};
		case 'TableViewerRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$TableViewer(_user$project$Pages_TableViewer$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$TableViewerMsg, _user$project$Pages_TableViewer$fetchdata)
			};
		case 'TableRoute':
			var _p2 = _p1._0;
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$TableData(
					_user$project$Pages_TableData$init(_p2)),
				_1: A2(
					_elm_lang$core$Platform_Cmd$map,
					_user$project$Msgs$TableDataMsg,
					_user$project$Pages_TableData$fetchdata(_p2))
			};
		case 'TraceOverviewRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$TraceOverview(_user$project$Pages_TraceOverview$model),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		case 'ProcessesRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$Processes(_user$project$Pages_Processes$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$ProcessesMsg, _user$project$Pages_Processes$fetchdata)
			};
		case 'ProcessRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$Process(
					_user$project$Pages_Process$init(_p1._0)),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$ProcessMsg, _user$project$Pages_Process$fetchdata)
			};
		case 'PortsRoute':
			return {
				ctor: '_Tuple2',
				_0: _user$project$Models$Ports(_user$project$Pages_Ports$model),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$PortsMsg, _user$project$Pages_Ports$fetchdata)
			};
		default:
			return {ctor: '_Tuple2', _0: _user$project$Models$NotFound, _1: _elm_lang$core$Platform_Cmd$none};
	}
};
			...
			function (toModel, toMsg, subUpdate, subMsg, subModel) {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tab: toModel(newModel)
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, toMsg, newCmd)
				};
			});
		var _p4 = {ctor: '_Tuple2', _0: model.tab, _1: msg};
		_v2_25:
		do {
			switch (_p4._1.ctor) {
				case 'Mdl':
					return A3(_debois$elm_mdl$Material$update, _user$project$Msgs$Mdl, _p4._1._0, model);
				case 'OnLocationChange':
					var newRoute = _user$project$Routing$parseLocation(_p4._1._0);
					var _p5 = _user$project$Main$routeToPage(newRoute);
					var tab = _p5._0;
					var cmd = _p5._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								tab: tab,
								title: _user$project$Routing$title(newRoute)
							}),
						_1: cmd
					};
				case 'SystemMsg':
					if (_p4._0.ctor === 'System') {
						return A5(toPage, _user$project$Models$System, _user$project$Msgs$SystemMsg, _user$project$Pages_System$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'LoadChartsMsg':
					if (_p4._0.ctor === 'LoadCharts') {
						return A5(toPage, _user$project$Models$LoadCharts, _user$project$Msgs$LoadChartsMsg, _user$project$Pages_LoadCharts$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'MemoryAllocatorsMsg':
					if (_p4._0.ctor === 'MemoryAllocators') {
						return A5(toPage, _user$project$Models$MemoryAllocators, _user$project$Msgs$MemoryAllocatorsMsg, _user$project$Pages_MemoryAllocators$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'ApplicationsMsg':
					if (_p4._0.ctor === 'Applications') {
						return A5(toPage, _user$project$Models$Applications, _user$project$Msgs$ApplicationsMsg, _user$project$Pages_Applications$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'ProcessMsg':
					if (_p4._0.ctor === 'Process') {
						return A5(toPage, _user$project$Models$Process, _user$project$Msgs$ProcessMsg, _user$project$Pages_Process$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'ProcessesMsg':
					if (_p4._0.ctor === 'Processes') {
						return A5(toPage, _user$project$Models$Processes, _user$project$Msgs$ProcessesMsg, _user$project$Pages_Processes$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'PortsMsg':
					if (_p4._0.ctor === 'Ports') {
						return A5(toPage, _user$project$Models$Ports, _user$project$Msgs$PortsMsg, _user$project$Pages_Ports$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'TableViewerMsg':
					if (_p4._0.ctor === 'TableViewer') {
						return A5(toPage, _user$project$Models$TableViewer, _user$project$Msgs$TableViewerMsg, _user$project$Pages_TableViewer$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'TableDataMsg':
					if (_p4._0.ctor === 'TableData') {
						return A5(toPage, _user$project$Models$TableData, _user$project$Msgs$TableDataMsg, _user$project$Pages_TableData$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'TraceOverviewMsg':
					if (_p4._0.ctor === 'TraceOverview') {
						return A5(toPage, _user$project$Models$TraceOverview, _user$project$Msgs$TraceOverviewMsg, _user$project$Pages_TraceOverview$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'AboutMsg':
					if (_p4._0.ctor === 'About') {
						return A5(toPage, _user$project$Models$About, _user$project$Msgs$AboutMsg, _user$project$Pages_About$update, _p4._1._0, _p4._0._0);
					} else {
						break _v2_25;
					}
				case 'NewNodesMsg':
					if (_p4._1._0.ctor === 'Ok') {
						return {
							ctor: '_Tuple2',
							_0: A2(_user$project$Main$updateNodes, _p4._1._0._0, model),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'ChangeNodeNameMsg':
					var connectNode = model.connectNode;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								connectNode: _elm_lang$core$Native_Utils.update(
									connectNode,
									{nodeName: _p4._1._0})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ChangeNodeCookieMsg':
					var connectNode = model.connectNode;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
				...
				case 'ConnectNodeMsg':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$connectNode(model)
					};
				case 'ChangeNode':
					var _p6 = _p4._1._0;
					if (_p6.ctor === 'Just') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: _user$project$Main$changeNode(_p6._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'ConnectNodeResponseMsg':
					if (_p4._1._0.ctor === 'Ok') {
						var _p8 = _p4._1._0._0;
						var _p7 = A2(
							_debois$elm_mdl$Material_Helpers$map2nd,
							_elm_lang$core$Platform_Cmd$map(_user$project$Msgs$Snackbar),
							A2(
									...
									A2(
										...
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												' Connected: ',
												_elm_lang$core$Basics$toString(_p8.connected))))),
								model.snackbar));
						var snackbar = _p7._0;
						var cmd = _p7._1;
						var selectedNode = _p8.connected ? _elm_lang$core$Maybe$Just(_p8.node) : model.selectedNode;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{snackbar: snackbar, selectedNode: selectedNode}),
							_1: cmd
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						...
						default:
							return A2(
								...
								A2(
									...
									A2(_debois$elm_mdl$Material_Snackbar$update, _p4._1._0, model.snackbar)));
					}
			}
		} while(false);
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Main$init = function (location) {
	...
	var _p9 = _user$project$Main$routeToPage(currentRoute);
	var tab = _p9._0;
	var c = _p9._1;
	var cmd = _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msgs$SystemMsg, _user$project$Pages_System$fetchdata),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$http$Http$send, _user$project$Msgs$NewNodesMsg, _user$project$Main$getNodes),
				_1: {
					ctor: '::',
					_0: c,
					_1: {ctor: '[]'}
	...
	return {
		ctor: '_Tuple2',
		_0: _user$project$Models$initialModel(tab),
		_1: cmd
	};
};
